...
namespace Stork_Future_TaoLi
{
    public class ProxyHub:Hub
    {
        ...
        public void linkIn(String strategies)
        {
            Join(strategies);
        }
        ...
        {
            PushStrategyInfo.Instance.leave(connectionID);
        }
    }
    ...
    public class PushStrategyInfo
    {
        ...
        public void UpdateStrategyInfo(string name, string Info)
        {
            ...
            _context.Clients.Client(RegisterRelation[name]).updatePara();
        }
    }
}